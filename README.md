...
│   └── .gitkeep
├── 🌍 intelliflow_env/                  # Virtual environment (development)
├── 🚀 pathway_env/                      # Pathway environment (streaming)
├── ⚙️ streamlit/                        # Streamlit configuration
│   └── secrets.toml                     # Streamlit secrets
├── 📄 .dockerignore                     # Docker ignore patterns
├── 📄 .gitignore                        # Git ignore patterns
├── 📄 docker-compose.yml                # Multi-container setup
├── 📄 migrate-to-pathway.py             # Migration utility
├── 📄 README.md                         # Project documentation
├── 📄 README-PATHWAY.md                 # Pathway-specific documentation
├── 📄 requirements.txt                  # Standard Python dependencies
├── 📄 requirements-pathway.txt          # Pathway-specific dependencies
├── 📄 run-windows.bat                   # Windows startup script
...
- **`backend/`**: Core FastAPI application with modular API endpoints, analytics, and data processing
- **`frontend/`**: Streamlit-based dashboard with component-based architecture
- **`data/`**: Data management layer with validation, generation, and schema definitions
- **`config/`**: Environment-specific configuration management
- **`scripts/`**: Utility scripts for data generation, demos, and health checks
- **`tests/`**: Comprehensive testing suite with unit, integration, and load tests
- **`infrastructure/`**: Container orchestration and deployment configurations
- **Virtual Environments**: Separate environments for standard operations and Pathway streaming
- **Batch Files**: Windows-specific startup scripts for easy development
=======
...
└── 📄 docker-compose.yml               # Multi-container setup
>>>>>>> b76fa53c752c7053862d8d5c2dcb51b383aece3f
```
